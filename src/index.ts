...
export const fizzlPlugin: Plugin = {
  name: "fizzl",
  description:
    "Fizzl's x402 agent services: Ichimoku Cloud trading signals (Solana/Base) and PlainText wallet-approval risk checks (Base), paid per call in USDC.",
  actions: [ichimokuSignalAction, checkWalletApprovalsAction, explainApprovalAction],
...
export { ichimokuSignalAction, checkWalletApprovalsAction, explainApprovalAction };
export { FizzlClient } from "./client.js";
export { parseSignalInput, parseWalletInput, parseApprovalPayload } from "./parse.js";
