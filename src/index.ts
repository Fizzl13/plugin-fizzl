...
import { confluenceSignalAction, priceLevelsAction } from "./actions/trading-signals.js";
...
export const fizzlPlugin: Plugin = {
  name: "fizzl",
  description:
    "Fizzl's x402 agent services: Ichimoku Cloud, 6-indicator confluence and price-level trading signals (Solana/Base), PlainText wallet-approval risk checks (Solana/Base), x402 Doctor pre-payment checks and endpoint diagnosis (Solana/Base) and presign-guard checks before signing (Base), paid per call in USDC.",
  actions: [ichimokuSignalAction, confluenceSignalAction, priceLevelsAction, checkWalletApprovalsAction, explainApprovalAction, preflightX402Action, diagnoseX402Action, presignCheckAction],
...
export { ichimokuSignalAction, confluenceSignalAction, priceLevelsAction, checkWalletApprovalsAction, explainApprovalAction, preflightX402Action, diagnoseX402Action, presignCheckAction };
...
export type { PresignVerdict, PresignReason, ConfluenceSignal, PriceLevels, PricePlan } from "./services.js";
export { getConfluenceSignal, getPriceLevels } from "./services.js";
